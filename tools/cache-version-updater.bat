...
echo [2/11] Updating embeds/index.html...
...
echo [3/11] Updating emojis/index.html...
...
echo [4/11] Updating permissions/index.html...
...
echo [5/11] Updating pullback/index.html...
...
echo [6/11] Updating settings/index.html...
...
echo [7/11] Updating sync/index.html...
...
echo [8/11] Updating users/index.html...
...
echo [9/11] Updating dashboard/index.html...
...
echo [9/11] Updating dashboard/index.html...
powershell -Command "(Get-Content '..\webroot\admin\dashboard\extensions\index.html') -replace 'sidebar.js\?v=%current_version%', 'sidebar.js?v=%new_version%' -replace 'permissions.js\?v=%current_version%', 'permissions.js?v=%new_version%' | Set-Content '..\webroot\admin\dashboard\extensions\index.html'"
